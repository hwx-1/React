...
export declare class HosVersionMapper {
     ...
     * @deprecated 请使用`getBaseApi(string)`代替
     ...
     * @return 一般情况下baseApi只会有一个，由于3.0.0同时对应api8和api7，因此这里的返回类型改成了List
     */
    getFullBaseApi(hosVersion: string): string[];
    /**
     * 获取当前IDE所能支持的版本列表
     *
     ...
     * @deprecated 请使用`getHosVersionByFullBaseApi(fullBaseApi: string)`替代
     ...
     * 根据baseApi查询与之配套的HarmonyOS Version
     *
     * @param fullBaseApi OpenHarmony的API Version
     * @return HarmonyOS Version，如果查不到就返回空字符串
     */
    getHosVersionByFullBaseApi(fullBaseApi: string | undefined): string;
    /**
