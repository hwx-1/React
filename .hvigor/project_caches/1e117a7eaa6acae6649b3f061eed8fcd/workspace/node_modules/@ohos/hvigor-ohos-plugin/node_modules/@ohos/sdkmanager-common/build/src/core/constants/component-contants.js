...
exports.defaultGrsUrls = exports.ComponentPath = exports.VERSION_2_0_0 = exports.API_VERSION_PATTERN = exports.META_VERSION_PATTERN = exports.VERSION_PATTERN = void 0;
 ...
 * apiVersion字段的正则表达式
 */
exports.API_VERSION_PATTERN = /^(?:[1-9]\d{0,2}|[1-9]\d{0,2}\.[1-9]\d{0,2}|[1-9]\d{0,2}\.(?:0|[1-9]\d{0,2})\.[1-9]\d{0,2})$/;
/**
