...
type CompileEventType = 'duration' | 'continual';
/**
 * 对应hvigor中的EventHead
 */
 ...
 */
export type CompileEventState = 'created' | 'beginning' | 'running' | 'failed' | 'success' | 'warn';
/**
...
export declare class CompileEvent {
    ...
    getUseTime(): number;
    deleteChild(children: string): void;
