...
const pageIndexTemplate = (testTemplateParam) => {
    ...
    global[savePath] = "${testTemplateParam.modulePath.replace(/\\/g, '/')}/.test/default/intermediates/test/coverage_data/js_coverage.json";
    global[readPath] = "${testTemplateParam.modulePath.replace(/\\/g, '/')}/.test/default/intermediates/test/coverage_data/js_coverage.json"
